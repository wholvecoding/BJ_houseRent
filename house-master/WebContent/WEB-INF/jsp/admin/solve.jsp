...
<div class="search-wrap">
            <div class="search-content">
                <form action="${pageContext.request.contextPath}/./wrong/selectall.action" method="post" name="myform">
								...
								<c:forEach items="${solve}" var="solve">
									<tr
										...
										<td>
													...
													<a class="link-update"
											href="${pageContext.request.contextPath}/./wrong/deletesolve.action?id=${solve.id}"
