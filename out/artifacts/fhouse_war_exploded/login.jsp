...
<div class="wrapper">
	...
	<div class="container">
		...
		<form class="form" id="registerform" action="./logincheck.action" method="post">
			<li><a href="${pageContext.request.contextPath}/./toregister.action"><i class="icon-font">&#xe008;</i>还没有账户？点击注册</a></li>
		</form>
...
<script type="text/javascript">
	 ...
	 $().ready(function() {//利用jquery来将数据传递到后台
        // 在键盘按下并释放及提交后验证提交表单
        $("#loginform").validate({
        	success:function(){
