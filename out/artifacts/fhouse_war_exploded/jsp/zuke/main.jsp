    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on sendRequest" href="javascript::void(0)" onclick="to_page('${pageContext.request.contextPath}/./toindex.action')"></a></li>
            ...
            <ul class="sidebar-list">
               ...
               <div class="p">     <ul class="sub-menu">
                ...
                <li>
                  ...
                  <div class="p">   <ul class="sub-menu">
                        <li><a href="${pageContext.request.contextPath}/./findhasuserlist.action"><i class="icon-font">&#xe017;</i>账户实名</a></li>
