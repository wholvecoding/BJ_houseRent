...
<div class="search-wrap">
            <div class="search-content">
                <form action="${pageContext.request.contextPath}/./paid/selectall.action" method="post" name="myform">
								...
								<c:forEach items="${paid}" var="paid">
									<tr
										...
										<td>
													...
													<a class="link-update"
											href="${pageContext.request.contextPath}/./paid/deletepaid.action?id=${paid.id}"
