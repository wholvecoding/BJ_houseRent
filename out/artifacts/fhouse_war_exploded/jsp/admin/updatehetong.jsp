...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/./hetong/changehetong.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="address" value="${hetong.address }" id="address" size="50" type="text" required></td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                              ...
                              <td><input class="common-text" name="fromdate" id="fromdate" value="${hetong.fromdate}" size="50"  type="text" ></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>退租时间：</th>
                              <td><input class="common-text"  name="todate" id="todate" value="${hetong.todate}"  size="50"  type="text" ></td>
                            </tr>
                            <tr>
