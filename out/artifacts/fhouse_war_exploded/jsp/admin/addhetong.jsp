...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/./hetong/inserthetong.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><input class="common-text" name="price" id="price" value="${hetong.price}" size="50"  type="text" required></td>
                            </tr>
                            <tr>
