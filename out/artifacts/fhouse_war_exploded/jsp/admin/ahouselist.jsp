...
<h1>房源列表</h1>
	...
	<form id="houseForm" name="houseForm"
		action="${pageContext.request.contextPath}/./ahouselist.action"
		method=post >
						 <div class="result-title">
								...
								<c:forEach items="${houselist}" var="houselist">
									...
									<tr
										...
										<td><a class="link-update"
											href="${pageContext.request.contextPath}/./findid.action?id=${houselist.id}">修改</a>
											&nbsp;&nbsp; 
											<input type="hidden" name="id" value="${houselist.id}"/>
											<a class="link-del"
											 href="${pageContext.request.contextPath}/./deletehouse.action?id=${houselist.id}"
